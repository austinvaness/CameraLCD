...
namespace avaness.CameraLCDRevived
{
    public class MyGuiScreenPluginConfig : MyGuiScreenBase
    {
        ...
        protected void BuildControls()
        {
            ...
            myGuiControlSeparatorList2.AddHorizontal(-new Vector2(this.m_size.Value.X * 0.78f / 2f, -this.m_size.Value.Y / 2f + 0.023f), this.m_size.Value.X * 0.79f, 0f, null);
            this.Controls.Add(myGuiControlSeparatorList2);

            this.m_okBtn = new MyGuiControlButton(new Vector2?(new Vector2(0, 0.40f)), MyGuiControlButtonStyleEnum.Default, null, null, MyGuiDrawAlignEnum.HORISONTAL_CENTER_AND_VERTICAL_BOTTOM, null, MyTexts.Get(MyCommonTexts.Close), 0.8f, MyGuiDrawAlignEnum.HORISONTAL_CENTER_AND_VERTICAL_CENTER, MyGuiControlHighlightType.WHEN_ACTIVE, new Action<MyGuiControlButton>(this.OnCloseButtonClick), GuiSounds.MouseClick, 1f, null, false);
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y - 0.05f), null, "Enabled"));
            ...
            this.Controls.Add(myGuiControlCheckbox2);

            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0f), null, "Steal frames"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.05f), null, "Render ratio"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.1f), null, "Sprite Fix"));
            ...
            this.Controls.Add(myGuiControlCheckbox3);

            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.15f), null, "Shadows"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.2f), null, "Bloom"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.25f), null, "Billboards"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.30f), null, "Flares"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.35f), null, "Fxaa"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.40f), null, "Head fix"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.45f), null, "Update LOD"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.50f), null, "Show debug stats"));
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(-0.16f, y + 0.55f), null, "Render range"));
            ...
            this.Controls.Add(myGuiControlSlider);

            this.Controls.Add(myGuiControlCombobox);
